...
sap.ui.define([
	...
	return BaseController.extend("au.com.bournedigital.developertest.controller.Object", {
		...
		_onBindingChange: function () {
			...
			this._unitPriceTotal(oViewModel);
		...
		_unitPriceTotal: function (oViewModel) {
			var totalUnitPrice = 0;
			var oTable = this.byId("idOrderDetailsTable");
			var oTableItem = oTable.getBinding("items");
			var contexts = oTableItem.getCurrentContexts();
			$.each(contexts, function (i, context) {
				var data = context.getObject();
				totalUnitPrice = (totalUnitPrice + parseFloat(data.UnitPrice));
			});

			oViewModel.setProperty("/TotalValue", Math.floor(totalUnitPrice));
